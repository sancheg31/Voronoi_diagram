...
void	Voronoi::RemoveParabola(VEvent * e)
{
	...
	VParabola* xl = p1->getLeftParent();
	VParabola* xr = p1->getRightParent();

	VParabola* p0 = xl->getLeftChild();
	VParabola* p2 = xr->getRightChild();
...
{
	VParabola* left = par->getLeftChild();
	VParabola* right = par->getRightChild();
...
{
	VParabola* lp = b->getLeftParent();
	VParabola* rp = b->getRightParent();

	VParabola* a = lp->getLeftChild();
	VParabola* c = rp->getRightChild();
